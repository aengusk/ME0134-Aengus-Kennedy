...
def calculate_speed():
    ...
    speed_left = left_cps   / counts_per_wheel_revolution * circumference_wheel # in [mm / second]
    speed_right = right_cps / counts_per_wheel_revolution * circumference_wheel # in [mm / second]
...
def update_effort(speed_left, speed_right):
    ...
    left_motor.set_effort(left_effort) # NOTE negative sign removed
...
# board.wait_for_button()  # Wait for the button to start # NOTE disabled wait for button
